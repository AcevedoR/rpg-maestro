...
async function bootstrap() {
  ...
  const documentFactory = () => SwaggerModule.createDocument(app, new DocumentBuilder()
    ...
    .setDescription('For /maestro API, use your CF_Authorization cookie, for example: curl -H "cookie: CF_Authorization=XXXX" https://fourgate.cloud/api/maestro/sessions/default-current-session/tracks\nthis doc is WIP, bodies and responses are not documented yet')
