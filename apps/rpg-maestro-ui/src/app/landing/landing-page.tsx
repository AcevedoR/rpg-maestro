...
function LandingTabPanel({ index, activeTab, children }: { index: number; activeTab: number; children: ReactNode }) {
  return (
    <div
      role="tabpanel"
...
const tabA11yProps = (index: number) => ({
  ...
  'aria-controls': `landing-tabpanel-${index}`,
});
  ...
  return (
    <div className="landing">
      ...
      <Tabs
        ...
        value={activeTab}
        onChange={(_event, newTab) => setActiveTab(newTab)}
        textColor="secondary"
      ...
      >
        <Tab label="How it works" {...tabA11yProps(0)} />
        <Tab label="The problem" {...tabA11yProps(1)} />
        <Tab label="Pricing" {...tabA11yProps(2)} />
        <Tab label="FAQ" {...tabA11yProps(3)} />
      </Tabs>

      <LandingTabPanel index={0} activeTab={activeTab}>
        <section>
          <h2>How it works</h2>
          ...
          <p>
            Bring your own library (upload your files, tag them, build collections) — or use ours. Both work on the
            free tier: <strong>test the sync with the music you already play.</strong>
          </p>
        </section>
      </LandingTabPanel>

      <LandingTabPanel index={1} activeTab={activeTab}>
        <section>
          ...
          <ul className="landing-problem-list">
            ...
            <li>
              Other soundboards sound great <em>on your machine</em>. Your remote players hear nothing, so you pipe
              audio through Kenku FM into Discord… until an update breaks the chain.
            </li>
            <li>
        ...
        <section>
          ...
          <p>
            No stock-loop soup. Original ambience and combat tracks, composed and produced by a working musician who
            GMs weekly — tagged by scene and mood, ready mid-session. New tracks land every month.{' '}
            <em>(Every track is licensed for personal table use.)</em>
          </p>
        </section>
      </LandingTabPanel>

      <LandingTabPanel index={2} activeTab={activeTab}>
      ...
      <LandingTabPanel index={3} activeTab={activeTab}>
        <section>
          <h2>FAQ</h2>
          <div className="landing-faq">
            ...
            <p>
              Yes, on the free tier too (up to 30 tracks) — your files, your tags, your collections. Maestro raises it
              to 10 GB, about 1,200 tracks.
            </p>
            <h3>What happens to my uploads?</h3>
            <p>
              They're re-encoded for smooth streaming to your players, kept private to your sessions, and never shared
              or made public. Free-tier libraries may be cleared after long inactivity — we'll email you first.
            </p>
            <h3>What do I actually pay for?</h3>
            <p>
              The music. Sync, sharing and your own uploads stay free; Maestro buys the original collections I compose
              and the new ones landing every month.
            </p>
